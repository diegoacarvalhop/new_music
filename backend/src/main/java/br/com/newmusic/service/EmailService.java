...
public class EmailService {
    ...
    @Value("${newmusic.mail.from:noreply@newmusic.local}")
    ...
    public void enviarEmailRedefinicaoSenha(String destinatario, String linkRedefinicao) {
        String assunto = "New Music - Redefinição de senha";
        String texto = "Você solicitou a redefinição de senha. Acesse o link abaixo (válido por 1 hora):\n\n" + linkRedefinicao + "\n\nSe não foi você, ignore este e-mail.";
